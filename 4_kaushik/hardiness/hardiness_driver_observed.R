...
write.table(output_CDI, file = paste0(output_dir, "consolidated_observed_historical.csv"),sep = ",",col.names = !file.exists(paste0(output_dir, "consolidated_observed_historical.csv", ".csv")),row.names= FALSE,append = TRUE )
